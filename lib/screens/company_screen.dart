      ...
      body: FutureBuilder<List<Company>>(
        ...
        builder: (context, snapshot) {
          ...
          if (companies.isEmpty) {
            return const Center(child: Text('No companies yet. Tap + Company to create one.'));
          }
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => LedgerScreen(company: company)),
                ),
              );
            },
          );
        ...
        child: Column(
          ...
          children: [
            TextFormField(
              ...
              validator: (value) => value == null || value.trim().isEmpty ? 'Enter company name' : null,
            ),
            TextFormField(
              controller: _gstin,
          ...
          onPressed: () {
            ...
            Navigator.pop(
              ...
              Company(
                ...
                fromDate: DateTime(DateTime.now().year, 4, 1),
                toDate: DateTime(DateTime.now().year + 1, 3, 31),
